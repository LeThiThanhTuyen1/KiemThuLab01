...
public class Currency {
    ...
    public Integer universalValue(Integer amount) {
        ...
        BigDecimal rateBD = new BigDecimal(this.rate);
        BigDecimal universalValue = amountBD.multiply(rateBD);
        return universalValue.setScale(0, RoundingMode.HALF_EVEN).intValue();
    }
    ...
    public Integer valueInThisCurrency(Integer amount, Currency otherCurrency) {
        BigDecimal amountBD = new BigDecimal(amount);
        BigDecimal otherRateBD = new BigDecimal(otherCurrency.getRate());
        BigDecimal thisRateBD = new BigDecimal(this.rate);
        BigDecimal universalAmount = amountBD.multiply(otherRateBD);
        BigDecimal amountInThisCurrency = universalAmount.divide(thisRateBD, RoundingMode.HALF_EVEN);
        return amountInThisCurrency.setScale(0, RoundingMode.HALF_EVEN).intValue();
    }
}
